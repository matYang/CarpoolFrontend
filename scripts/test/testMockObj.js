...
var testMockObj = {
	...
	"sampleTransactionA": (new Transaction()).set("transactionId", 101).set("state",0).set("direction",0).set("departure_seatsBooked",2).set("arrival_seatsBooked",2).set("departure_priceList",[20,18, 15]),
