            ...
            <div class="left_bar">
                <div class="left_bar_inner">
                    ...
                    <dl class="contact clearfix">
                        <dt class="clearfix"><span class="fleft">联系方式</span><span class="fright">编辑</span></dt>
                        <dd>电话：<%= phone %></dd>
                        <dd>邮箱：<%= email %></dd>
                        <dd>QQ：<%= qq %></dd>
                    </dl>
                    <dl class="verification clearfix">
                        <dt class="clearfix"><span class="fleft">验证信息</span><span class="fright">编辑</span></dt>
...
<script type="text/template" id="tpl_personalSocialCard">
    <dl id="socialCard_<%= userId %>" class="follows clearfix">
        ...
        <dd>
            ...
            <p><span class="followed">已关注</span><span id="social_cancel_<%= userId %>" class="cancel">取消</span></p>
        </dd>
    </dl>
</script>
                ...
                <dl id = 'profileDropdown'>
                    ...
                    <dd style="display:none">
                        <ul>
                            ...
                            <li><a href="uwse@me.com">意见反馈</a></li>
