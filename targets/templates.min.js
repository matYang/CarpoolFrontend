      ...
      <div class="messageDetail-upper-info">
          ...
          <dl class="arrival clearfix">
            <% if ( transactionId === -1 && arrival_seatsNumber &&  arrival_seatsNumber > 0 ) { %>
              <dt>返回时间：</dt>
              <dd><%= arrival_time %>&nbsp;&nbsp;&nbsp;&nbsp;12:00 <label>剩余座位：<%= arrival_seatsNumber %>个</label></dd>
            <% } else { %>
              <dt>返回时间：</dt>
        ...
        <div class="messageDetail clearfix">
            ...
            <div class="messageDetail-upper messageDetail-upper-driver">
                ...
                <div class="messageDetail-upper-info">
                    ...
                    <dl class="departure clearfix">
                        <dt>出发时间：</dt>
                        <dd><%= departure_time %>&nbsp;&nbsp;&nbsp;&nbsp;12:00 <label>剩余座位：<%= departure_seatsNumber - departure_seatsBooked %>个</label></dd>
                    </dl>

                    <dl class="arrival clearfix">
                        <dt>返回时间：</dt>
                        <% if (isRoundTrip) {%>
                        <dd><%= arrival_time %>&nbsp;&nbsp;&nbsp;&nbsp;12:00 <label>剩余座位：<%= arrival_seatsNumber - arrival_seatsBooked %>个</label></dd>
                        <% } else {%>
                        <dd>---- <label>剩余座位：---- </label></dd>
                        <% }%>
                    </dl>
                    ...
                    <dl class="price clearfix">
                        <dt>单<s></s>价 : </dt>
                        <dd class="priceDisplay">
                            <span class="F_red F_18">50</span>元/人&nbsp;&nbsp;&nbsp;&nbsp;（多人可优惠 <a class="F_blue" href="#">查看详情</a>）
                        </dd>
                        <dd class="priceList">
                           <ul id="pricelist">
                           </ul> 
    ...
    <div class='topBar'>
        <div class="topBar-inner clearfix">
            ...
            <form id='login'>
                ...
                <div id='login_button' class='button' style='background-color: #ffffff; float:right; margin:10px'>登陆</div>
                <div id='signup_button' class='button' style='background-color: #ffffff; float:right;  margin:10px'>注册</div>
            </form>
        </div>
    </div>
    <div id='topNoticeBar'></div>
