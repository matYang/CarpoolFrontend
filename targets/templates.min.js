        ...
        <div class="mainPage-searchBanner">
            <div class="mainPage-searchBanner-inner">
                <div class="mainPage-searchBanner-searchBox form clearfix">
                    <div class="from"><label></label><input id="searchLocationInput_from" class="text" type="text" value="出发地"><span></span></div>
                    <div class="date"><label></label><input id="searchDateInput_depart" class="text" type="text" value=""><span></span></div>
                    <div class="zh"></div>
                    <div class="to"><label></label><input id="searchLocationInput_to" class="text" type="text" value="目的地"><span></span></div>    
                    <div class="date"><label></label><input  id="searchDateInput_return" class="text" type="text" value=""><span></span></div>
                </div>
            </div>
        </div>
        <!--主页搜索区域 end-->
