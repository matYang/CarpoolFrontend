...
<script type="text/template" id="tpl_personalNotificationHistory">
    <div id='personal_notification_<%= notificationId %>' class = 'personal_notification_message'>
        <div class="personal_notification_userDp" data-initUserId='<%= initUserId %>'>
            <img src='<%= imgPath %>'/>
        </div><%= initUser.name %><span class="actionText"></span>
    ...
    <tr id='personal_notification_<%= notificationId %>' class="notice_entry">
        ...
        <td width="180"><dl class="user">
                <dt><a href="#"><img src="<%= imgPath %>"/></a></dt>
                <dd class="name"><a href="#">RouteA</a>说</dd>
        ...
        <td class="delete" width="50"><a href="#">删除</a></td>
    </tr>
...
<script type="text/template" id="tpl_personalNotification">
    ...
    <div class="notice">
        ...
        <div class="clearfix">
            ...
            <div class="page clearfix fright"> <a class="pre pre-disabled" href="#">上一页</a> <a class="active" href="#">1</a> <a href="#">2</a> <a class="next" href="#">下一页</a> </div>
        </div>
    </div>
</script>
