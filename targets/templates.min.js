      ...
      <div class="myPage_content">
          ...
          <div id='utility_personalInfo' class="account">
            <dl class="clearfix">
                <dt><span>*</span>姓名：</dt>
                <dd>
                    <input type="text" class="text" name='name' value="李易峰"/>
            ...
            <dl class="birthday clearfix">
                ...
                <dd>
                    <div class="select_item1">
                        <input type="text" class="text" value="1986"  name='birthyear'>
                        <span></span>
                    ...
                    <label>年</label>
                    <div class="select_item1">
                        <input type="text" class="text" value="09"  name='birthmonth'>
                        <span></span>
                        <ul style="display:none">
                            <li>08</li>
                            <li>07</li>
                    ...
                    <label>月</label>
                    <div class="select_item1">
                        <input type="text" class="text" value="12"  name='birthyday'>
                        <span></span>
                        <ul style="display:none">
                            <li>13</li>
                            <li>14</li>
            ...
            <dl class="clearfix">
                <dt><span>*</span>电话：</dt>
                <dd>
                    <input class="text" type="text" value="15801280329" name='phone'/>
                    <span class="right"></span> </dd>
                <dd class="wrong">
