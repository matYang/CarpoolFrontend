...
<script type="text/template" id="tpl_letter">
    <div id="chat_left" class="chat_left">
        ...
        <div class="chat_box_body">
            <div class="chat_source">来源 <span id="chat_from" class="F_blue"></span> 到 <span id="chat_to" class="F_blue"></span></div>
    ...
    <div class="chat_right">
        <div class="chat_box_title"><div class="fleft">最近联系人</div><a id="chat_contact_min" class="min" href="#">最小化</a> </div>
            ...
            <div class="sign_up_inner">
                ...
                <div class="account">
                    <dl class="clearfix">
                        <dt><span>*</span>邮箱：</dt>
                        <dd>
                            <input id="registerEmailInput" type="text" class="text" value="">
                            </dd>
                    </dl>
                    <dl class="clearfix">
                        <dt><span>*</span>密码：</dt>
                    ...
                    <dl class="address clearfix">
                        ...
                        <dd id="sign_up_location_container">
                            ...
                            <input id="myAddress" class="text" type="text" value="请输入具体地址">
                        </dd>
                    </dl>
                    <div class="btns">
