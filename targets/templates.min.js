          ...
          <dl class="clearfix">
              ...
              <% } else { %>  
                  <div class="enter_data">
                      <input id="transaction_book_number" type="text" class="text">
...
<script type="text/template" id="tpl_topBar-notLoggedIn">
    <div class='topBar'>
        <div class="topBar-inner clearfix">
          ...
          <div class="login">
              <span id="loginBoxToggler" class="hd">登录</span>
              <div id="loginBox" class="bd">
                  <ul>
                      ...
                      <li class="clearfix">
                          <div id="remember_password" class="checkbox checked">记住我</div>
