        ...
        <div class="myPage clearfix">
            <div class="left_bar">
                <div class="left_bar_inner">
                    ...
                    <dl class="my_car clearfix">
                        <dt class="clearfix"><span class="fleft">车辆信息</span><span class="fright">编辑</span></dt>
                        <dd>车型：奥迪A6</dd>
                        <dd>车牌号：5678900</dd>
                    </dl>
...
<script type="text/template" id="tpl_personalNotificationEntry">
    <tr id='personal_notification_<%= notificationId %>' class="notice_entry">
        <td class="check" width="50"><div class="checkbox checked"></div></td>
