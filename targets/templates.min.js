...
<script type="text/template" id="tpl_letter">
    <div id="chat_left" class="chat_left">
        <div class="chat_box_title">
            <div id="letter_toUser_name" class="fleft active"></div>
            <a id="chat_close" class="close" href="#">关闭</a> <a id="chat_hide" class="min" href="#">最小化</a> 
        </div>
        <div class="chat_box_body">
            <div class="chat_content">
                <div class="chat_content_scroll">
                    <em class="scroll_top"></em>
                    <em style="height: 70px;" class="scroll_main"></em>
                    <em class="scroll_bottom"></em>
                </div>
                <div id = 'letter_message_panel' class="chat_content_list">
                    <p id="letter_history" style="text-align:center"><a class="F_blue" href="#">查看历史信息</a></p>
                </div>
            </div>
    ...
    <div class="chat_right">
        <div class="chat_box_title"><div class="fleft">我的联系人</div><a id="chat_contact_min" class="min" href="#">最小化</a> </div>
        <dl id="letter_user_list">
        </dl>
    </div>
</script>
