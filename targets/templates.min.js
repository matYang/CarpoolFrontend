          ...
          <div id='utility_personalInfo' class="account">
            ...
            <dl class="birthday clearfix">
                ...
                <dd>
                    ...
                    <label>月</label>
                    <input type="text" class="text" name='birthyday'>
                    <label>日</label>
                </dd>
            </dl>
            <dl class="clearfix">
            ...
            <dl class="clearfix">
                <dt>邮箱：</dt>
                <dd>
                    <input class="text" type="text" value="" name=''/>
                </dd>
            </dl>
            <dl class="clearfix">
                <dt>QQ：</dt>
              ...
              <form method="post"  action="uploadImg.html" enctype="multipart/form-data" id="uploadform">
                    <dl>
                        ...
                        <dd>
                            ...
                            <div id="fileValid" class="wrong" style="display:none;"><p></p></div>
                        </dd>
                    </dl>
              </form>
          </div>
  ...
  <div class="sign_up">
    <div class="sign_up_inner">
        ...
        <div class="forgot_password">
            <p class="F_16">我们已将重设密码的链接发送到你的邮箱(Email)：<span id="email_value" class="F_orange"></span></p>
            <div class="blank2">
